(function () {
  ...
  //q allDeepEqual([ [1,2], [1,2] ]) ? still pending

  ///////////////////////////////////////////////////////////
  // strings
  //Q Convert a string in abbreviated form
  // 2 sept
  ...
  //         splitArray = splitArray[0] + " " + splitArray[1].charAt(0) + "."
  //     }
  //     return splitArray;
  // }

  // console.log(abbreviated(str))

  //Q parameterize a string
  // let str = "Robin Singh From USA."
  // const parameterize = (str) =>{
  //     let splitArray = str.split(' ');
  //    for(i=0;i<splitArray.length;i++){
  //     splitArray[i] =  splitArray[i][0].toLowerCase() + splitArray[i].slice(1,splitArray[i].length);
  //    }
  //    return (splitArray.join('-'))
  // }
  // console.log(parameterize(str))

  //Q find the max value of keys in an array of objects
  ...
  //Q sort array of bbject in decending order
...
//Q Write a JavaScript function to uncamelize a string

// const uncamelize =(str,paramerter = ' ') =>{
//    let arr = str.split('');
//    for(let i =0;i<arr.length;i++){
//      if(arr[i].toUpperCase() === arr[i]){
//         arr[i] = arr[i].toLowerCase();
//          arr.splice(i,0,paramerter);
//      }
//    }
//    return arr.join('')
// }
...
//Q insert a string in to another string
...
//    }
// console.log(insert('We are doing some exercisess.'));
// console.log(insert('We are doing some exercises.','JavaScript '));
// console.log(insert('We are doing some exercises.','JavaScript ',18));



//Q Write a JavaScript function to chop a string into chunks of a given length
